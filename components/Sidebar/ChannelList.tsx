...
export default function ChannelList({
  ...
  return (
    <div className="h-full bg-slate-900 flex flex-col min-h-0">
      <div className="p-4 md:p-6 border-b border-slate-800 flex justify-between items-center shadow-md">
      ...
      <div className="flex-1 overflow-y-auto p-2 md:p-3 space-y-4 md:space-y-6 min-h-0">
        <div 
          onClick={onOpenProfile}
          className="bg-slate-800/40 p-3 rounded-xl md:rounded-2xl border border-slate-700/50 mb-3 md:mb-4 cursor-pointer hover:bg-slate-800 transition-all group"
        >
      ...
      <div className="p-2 md:p-3 border-t border-slate-800">
        <button
          onClick={onLeaveRoom}
          className="w-full rounded-xl bg-slate-700 hover:bg-slate-600 text-[10px] md:text-[11px] font-black uppercase py-2"
        >
          Odadan Ayrıl
        </button>
      </div>
